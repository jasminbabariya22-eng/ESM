...
# Trigger dynamic registration of custom business workflow activities
import app.workflow_activities.risk_activities
...
# SpiffWorkflow Human Tasks API
from app.workflow.api.human_tasks import router as workflow_router
app.include_router(workflow_router)

# SpiffWorkflow Definitions API
from app.workflow.api.definitions import router as workflow_def_router
app.include_router(workflow_def_router)

# SpiffWorkflow Monitoring API
from app.workflow.api.monitoring import router as workflow_mon_router
app.include_router(workflow_mon_router)

# SpiffWorkflow Management Platform API
from app.workflow_management.api import router as workflow_mgmt_router
app.include_router(workflow_mgmt_router)
